...
public class CarInventory {
	...
	public static void main(String[] args) {
		...
		car.add(new CarInventory(2000, "NANO","TATA", 100000));
		car.add(new CarInventory(1996, "Alto","TATA", 550000));
		car.add(new CarInventory(1956, "Indica","TATA", 650000));
		car.add(new CarInventory(2000, "Nexa","TATA", 920000));
		car.add(new CarInventory(2000, "Thar","Mahindra", 1500000));
